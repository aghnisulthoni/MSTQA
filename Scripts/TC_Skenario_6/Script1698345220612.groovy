...
Mobile.tap(findTestObject('mst/addTodo/calendar/selectNextMonth'), 0)

Mobile.tap(findTestObject('mst/addTodo/calendar/pickDateOnNovember2023'), 0)
...
Mobile.tap(findTestObject('mst/addTodo/type/selectOthers'), 0)
