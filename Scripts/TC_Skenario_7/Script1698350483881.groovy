...
Mobile.tap(findTestObject('mst/addTodo/calendar/selectDateNow'), 0)

Mobile.tap(findTestObject('mst/addTodo/calendar/buttonOK'), 0)

Mobile.waitForElementPresent(findTestObject('mst/addTodo/type/fieldChooseType'), 0)
...
Mobile.tap(findTestObject('mst/addTodo/files/fieldChooseFile'), 0)

Mobile.waitForElementPresent(findTestObject('mst/addTodo/files/textRECENTIMAGES'), 1)

Mobile.tap(findTestObject('mst/addTodo/files/pickImageView'), 0, FailureHandling.STOP_ON_FAILURE)
...
Mobile.tap(findTestObject('mst/homepage/selectdataall'), 2)

Mobile.verifyElementVisible(findTestObject('mst/detailToDo/verifyHeaderDetailTodo'), 0)

WebUI.verifyMatch(Name, 'MST QA Test 3', false)

Mobile.verifyElementText(findTestObject('mst/detailToDo/verifyValueDate'), '27 October 2023')

Mobile.verifyElementText(findTestObject('mst/detailToDo/verifyValueSecondary'), 'Secondary')

WebUI.verifyMatch(Description, 'Testing 3', false)

Mobile.verifyElementVisible(findTestObject('mst/detailToDo/verifyImageView'), 0)
